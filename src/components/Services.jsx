        ...
        <div className="sm:grid grid-cols-2">
          <div className="sm:p-10 p-5 bg-gray-50 sm:me-5 mb-10 rounded-md hover:shadow-md">
            ...
            <p className="leading-10 text-gray-500 text-justify">
              ...
              hasta grandes corporaciones, mi enfoque se centra en crear
              experiencias digitales que cautiven a los usuarios y impulsen el
          ...
          <div className="sm:p-10 p-5 bg-gray-50 sm:me-5 mb-10 rounded-md hover:shadow-md">
            ...
            <p className="leading-10 text-gray-500 text-justify">
              ...
              navegación hasta la interfaz de usuario y la integración de bases
              de datos, cada aspecto de tu sitio web recibirá la atención
              detallada que merece.
            </p>
          </div>
          ...
          <div className="sm:p-10 p-5 bg-gray-50 sm:me-5 mb-10 rounded-md hover:shadow-md">
            ...
            <p className="leading-10 text-gray-500 text-justify">
              ...
              implementan las mejores prácticas de SEO para mejorar su
          ...
          <div className="sm:p-10 p-5 bg-gray-50 sm:me-5 mb-10 rounded-md hover:shadow-md">
            ...
            <p className="leading-10 text-gray-500 text-justify">
              ...
              configuración de tiendas en línea hasta la integración de
              pasarelas de pago seguras, estoy aquí para hacer que tu negocio
              prospere en el mundo digital.
            </p>
          </div>
          ...
          <div className="sm:p-10 p-5 bg-gray-50 sm:me-5 mb-10 rounded-md hover:shadow-md">
            ...
            <p className="leading-10 text-gray-500 text-justify">
              ...
              a tus requerimientos y presupuesto.
            </p>
          </div>
        </div>
      </div>

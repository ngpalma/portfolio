        ...
        <div className="lg:columns-4 sm:columns-2">
          <div className="p-5 bg-gray-50 sm:me-5 sm:mb-10 mb-5 rounded-md hover:shadow-md">
            <h3 className="text-xl mb-5">
              <a
                href="https://github.com/ngpalma/rick_and_morty"
                target="_blank"
              >
                Rick & Morty
              </a>
          ...
          <div className="p-5 bg-gray-50 sm:me-5 sm:mb-10 mb-5 rounded-md hover:shadow-md">
            <h3 className="text-xl mb-5">
              <a href="https://github.com/ngpalma/Countries" target="_blank">
                Info Paises
              </a>
            </h3>
          ...
          <div className="p-5 bg-gray-50 sm:me-5 sm:mb-10 mb-5 rounded-md hover:shadow-md">
            <h3 className="text-xl mb-5">
              <a
                href="https://github.com/ngpalma/clientToolVerse"
                target="_blank"
              >
                Tool Verse
              </a>
          ...
          <div className="p-5 bg-gray-50 sm:me-5 sm:mb-10 mb-5 rounded-md hover:shadow-md">
            <h3 className="text-xl mb-5">
              <a
                href="https://github.com/ngpalma/client-spLENDid-app"
                target="_blank"
              >
                spLENDid - En desarrollo
              </a>
            </h3>
